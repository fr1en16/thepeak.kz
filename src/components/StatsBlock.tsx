  ...
  return (
    ...
    >
      <div className="swiss-grid w-full h-full items-stretch md:items-center">
        ...
        {/* Card 1: 83% Retention */}
        <div className="col-span-12 md:col-span-4 flex items-center gap-3 md:gap-4 h-full py-3 md:py-2 border-b md:border-b-0">
          <div className="w-[clamp(3.5rem,5vw,6.5rem)] aspect-square flex-shrink-0 relative">
            {inView && <RingChart />}
          </div>
          <div className="flex flex-col text-left justify-center">
            <p className="no-invert font-headline font-semibold text-[clamp(1.1rem,1.5vw,1.4rem)] text-brand-gray !leading-[1.1]">
        ...
        <div className="col-span-12 md:col-span-3 flex items-center gap-3 md:gap-4 h-full py-3 md:py-2 border-b md:border-b-0 md:border-l md:border-r border-brand-gray/10 md:px-6">
          <div className="w-[clamp(5rem,7vw,9.5rem)] h-[clamp(3.5rem,5vw,6.5rem)] flex-shrink-0 relative">
            {inView && <SplineChart />}
          </div>
          <div className="flex flex-col text-left justify-center">
            <p className="no-invert font-headline font-semibold text-[clamp(1.1rem,1.5vw,1.4rem)] text-brand-gray !leading-[1.1]">
        ...
        {/* Card 3: 150+ Projects */}
        <div className="col-span-12 md:col-span-5 flex items-center gap-3 md:gap-4 h-full py-3 md:py-2">
          <div className="w-[clamp(3.5rem,6vw,7.8rem)] aspect-square flex-shrink-0 relative">
            {inView && <SphereChart />}
          </div>
          <div className="flex flex-col text-left justify-center">
            <span className="no-invert font-headline font-semibold text-brand-orange text-[clamp(1.1rem,1.5vw,1.4rem)] !leading-[1.1] block mb-1.5">
              {formatTypography("150+ проектов")}
            </span>
            <p className="no-invert font-sans font-medium text-[clamp(0.85rem,0.85vw,0.9rem)] text-brand-gray/80 leading-snug">
