...
export default function CasesMasonrySection() {
  ...
  return (
    <section
      className="col-span-12 w-[calc(100%+2*var(--page-margin))] -ml-[var(--page-margin)] overflow-hidden pt-[var(--page-margin)] pb-12 bg-white select-none scroll-mt-[clamp(2rem,2.8vw,3.5rem)]"
      id="cases"
    >
      {/* Header Container */}
