...
export default function CasesMasonrySection() {
  const casesData: CaseItem[] = [
    ...
    },
    {
      logo: "SENSATA GROUP",
      type: "продакшн",
      text: "Создали визуальный контент для жилого комплекса: от архитектурных ракурсов до динамичных роликов, которые раскрывают масштаб проекта и повышают доверие к бренду.",
      className: "col-span-1 lg:col-span-1 lg:row-span-1",
      href: "/cases/sensata",
    },
    {
    ...
    },
    {
      logo: "АЛМАТЫ МАРАФОН",
      type: "мероприятие",
      text: "Поддержали коммуникацию крупного спортивного события: усилили узнаваемость проекта, подготовили контент для digital-каналов и помогли собрать внимание аудитории вокруг старта.",
      className: "col-span-1 lg:col-span-1 lg:row-span-1",
      href: "#contacts",
    },
    {
      logo: "METRO",
      type: "продакшн",
      text: "Собрали продакшн-материалы для бренда: показали продукт, команду и атмосферу проекта через короткие видеоформаты для социальных сетей.",
