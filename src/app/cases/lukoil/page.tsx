...
// ─── Lukoil Lubricants Reels Data (6 items) ───────────────────────────────────
const lukoilReels = [
    { src: "https://www.instagram.com/reel/DVGo3-njT1s/embed" },
    { src: "https://www.instagram.com/reel/DZF2MIOosEB/embed" },
    { src: "https://www.instagram.com/reel/DYeXj_0qQYH/embed" },
    { src: "https://www.instagram.com/reel/DXb-h90k10a/embed" },
    { src: "https://www.instagram.com/reel/DQOcNl_jBHo/embed" },
    { src: "https://www.instagram.com/reel/DXzP2xeMldX/embed" },
];
            ...
            >
                ...
                <section className="relative min-h-screen flex flex-col justify-end overflow-hidden border-b border-white/10">
                    <div
                        ...
                        style={{ backgroundImage: "url('/cases/lukoil/hero.webp')" }}
                    />

                    <div
                        className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat opacity-35 block md:hidden"
                        style={{ backgroundImage: "url('/cases/lukoil/hero_m.webp')" }}
                    />
