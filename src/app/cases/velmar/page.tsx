...
// ─── Velmar Reels Data (9 unique items) ───────────────────────────────────────
const velmarReels = [
  { src: "https://www.instagram.com/reel/DZmID_UNrfO/embed" },
  { src: "https://www.instagram.com/reel/DZZ_mkctYPQ/embed" },
  { src: "https://www.instagram.com/reel/DZUFCZnNz30/embed" },
  { src: "https://www.instagram.com/reel/DZPOfEXNe10/embed" },
  { src: "https://www.instagram.com/reel/DY4cQgZNrY8/embed" },
  { src: "https://www.instagram.com/reel/DY4AC2ONAP0/embed" },
  { src: "https://www.instagram.com/reel/DYrkZ1eNlYc/embed" },
  { src: "https://www.instagram.com/reel/DYl2w2qNqJY/embed" },
  { src: "https://www.instagram.com/reel/DZEb7antllj/embed" },
];
      ...
      >
        ...
        <section className="relative min-h-screen flex flex-col justify-end overflow-hidden border-b border-white/10">
          <div
            ...
            style={{ backgroundImage: "url('/cases/velmar/hero.webp')" }}
          />

          <div
            className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat opacity-35 block md:hidden"
            style={{ backgroundImage: "url('/cases/velmar/hero_m.webp')" }}
          />
