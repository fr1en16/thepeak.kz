...
// ─── Gippo Reels Data (5 unique videos, duplicates and photos filtered out) ────
const gippoReels = [
    { src: "https://www.instagram.com/reel/DUlDVLpDATv/embed" },
    { src: "https://www.instagram.com/reel/DTrrVfLgnvF/embed" },
    { src: "https://www.instagram.com/reel/DSZ_eeijG3k/embed" },
    { src: "https://www.instagram.com/reel/DSPb7tojI1X/embed" },
    { src: "https://www.instagram.com/reel/DOso37sjCfM/embed" },
];
            ...
            >
                ...
                <section className="relative min-h-screen flex flex-col justify-end overflow-hidden border-b border-white/10">
                    <div
                        ...
                        style={{ backgroundImage: "url('/cases/gippo/hero.webp')" }}
                    />

                    <div
                        className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat opacity-35 block md:hidden"
                        style={{ backgroundImage: "url('/cases/gippo/hero_m.webp')" }}
                    />
