...
// ─── Double Coffee Reels Data (6 unique items) ───────────────────────────────
const doubleCoffeeReels = [
  { src: "https://www.instagram.com/reel/DQCMMzKDK2w/embed" },
  { src: "https://www.instagram.com/reel/DQHTarFjAWr/embed" },
  { src: "https://www.instagram.com/reel/DTw4VXmDOm5/embed" },
  { src: "https://www.instagram.com/reel/DUYO2pjDwU2/embed" },
  { src: "https://www.instagram.com/reel/DUzvxPzjFST/embed" },
  { src: "https://www.instagram.com/reel/DRj-CucDG_l/embed" },
];
      ...
      >
        ...
        <section className="relative border-b border-white/10 px-[var(--page-margin)] py-20 bg-[#0a0a0a]">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {doubleCoffeeReels.map((item, index) => (
              <div
                key={index}
              ...
              >
                ...
                <div className="relative w-full aspect-[9/16] bg-zinc-900 overflow-hidden">
                  <iframe
                    ...
                    title={`Double Coffee Reel ${index + 1}`}
                    loading="lazy"
                  />
                </div>
              </div>
