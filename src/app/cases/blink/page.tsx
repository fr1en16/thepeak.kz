...
// ─── Blink map Reels Data (6 unique videos, photo post filtered out) ──────────
const blinkMapReels = [
  { src: "https://www.instagram.com/reel/DNOYosnIbNg/embed" },
  { src: "https://www.instagram.com/reel/DNf454JIH5u/embed" },
  { src: "https://www.instagram.com/reel/DNm03plIVKB/embed" },
  { src: "https://www.instagram.com/reel/DNnHpH5o51d/embed" },
  { src: "https://www.instagram.com/reel/DNuOkuv0J1e/embed" },
  { src: "https://www.instagram.com/reel/DN8qH80iMvU/embed" },
];
      ...
      >
        ...
        <section className="relative min-h-screen flex flex-col justify-end overflow-hidden border-b border-white/10">
          <div
            ...
            style={{ backgroundImage: "url('/cases/blinkmap/hero.webp')" }}
          />

          <div
            className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat opacity-35 block md:hidden"
            style={{ backgroundImage: "url('/cases/blinkmap/hero_m.webp')" }}
          />
