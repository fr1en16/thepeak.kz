...
// ─── Mind of Body Reels Data (6 unique items, duplicate filtered out) ─────────
const mindOfBodyReels = [
    { src: "https://www.instagram.com/reel/DLrZQgFItsv/embed" },
    { src: "https://www.instagram.com/reel/DLQF-KGs3ET/embed" },
    { src: "https://www.instagram.com/reel/DLCHPBHI18j/embed" },
    { src: "https://www.instagram.com/reel/DME5f0rI1yp/embed" },
    { src: "https://www.instagram.com/reel/DMfE5fzoHU5/embed" },
    { src: "https://www.instagram.com/reel/DPoUbt1DDlO/embed" },
];
            ...
            >
                ...
                <section className="relative min-h-screen flex flex-col justify-end overflow-hidden border-b border-white/10">
                    <div
                        ...
                        style={{ backgroundImage: "url('/cases/mindofbody/hero.webp')" }}
                    />

                    <div
                        className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat opacity-35 block md:hidden"
                        style={{ backgroundImage: "url('/cases/mindofbody/hero_m.webp')" }}
                    />
                ...
                <section className="relative border-b border-white/10 px-[var(--page-margin)] py-20 bg-[#0a0a0a]">
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        {mindOfBodyReels.map((item, index) => (
                            <div
                                key={index}
                            ...
                            >
                                ...
                                <div className="relative w-full aspect-[9/16] bg-zinc-900 overflow-hidden">
                                    <iframe
                                        ...
                                        title={`Mind of Body Reel ${index + 1}`}
                                        loading="lazy"
                                    />
                                </div>
                            </div>
