...
// ─── Ris Reels Data (7 items) ────────────────────────────────────────────────
const risReels = [
  { src: "https://www.instagram.com/reel/DZKpy22t8wX/embed" },
  { src: "https://www.instagram.com/reel/DZFwmfLtANf/embed" },
  { src: "https://www.instagram.com/reel/DYj1D_ZtOBj/embed" },
  { src: "https://www.instagram.com/reel/DYZba6qNtf4/embed" },
  { src: "https://www.instagram.com/reel/DYRlMk0tf9z/embed" },
  { src: "https://www.instagram.com/reel/DZKo_OrKD84/embed" },
  { src: "https://www.instagram.com/reel/DXES3Q7Cok7/embed" },
];
      ...
      >
        ...
        <section className="relative min-h-screen flex flex-col justify-end overflow-hidden border-b border-white/10">
          <div
            ...
            style={{ backgroundImage: "url('/cases/ris/hero.webp')" }}
          />

          <div
            className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat opacity-35 block md:hidden"
            style={{ backgroundImage: "url('/cases/ris/hero_m.webp')" }}
          />
