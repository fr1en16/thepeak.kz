...
// ─── Avtopilot Reels Data (6 items) ───────────────────────────────────────────
const avtopilotReels = [
  { src: "https://www.instagram.com/reel/DT-T8jxCPxX/embed" },
  { src: "https://www.instagram.com/reel/DUpgPxxiLla/embed" },
  { src: "https://www.instagram.com/reel/DTMt8bOiN60/embed" },
  { src: "https://www.instagram.com/reel/DZg8A5_oprO/embed" },
  { src: "https://www.instagram.com/reel/DW52bOMiFjL/embed" },
  { src: "https://www.instagram.com/reel/DWnxIEhCG7k/embed" },
];
      ...
      >
        ...
        <section className="relative min-h-screen flex flex-col justify-end overflow-hidden border-b border-white/10">
          <div
            ...
            style={{ backgroundImage: "url('/cases/avtopilot/hero.webp')" }}
          />

          <div
            className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat opacity-35 block md:hidden"
            style={{ backgroundImage: "url('/cases/avtopilot/hero_m.webp')" }}
          />
