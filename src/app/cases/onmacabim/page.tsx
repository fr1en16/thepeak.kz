...
// ─── ONmacabim Reels Data (5 items) ───────────────────────────────────────────
const onmacabimReels = [
    { src: "https://www.instagram.com/reel/DIAtZHFILlf/embed" },
    { src: "https://www.instagram.com/reel/DIMPEyGs02q/embed" },
    { src: "https://www.instagram.com/reel/DIdC-Kxvrka/embed" },
    { src: "https://www.instagram.com/reel/DIijVNMMO1-/embed" },
    { src: "https://www.instagram.com/reel/DI_SbvpMpUM/embed" },
];
            ...
            >
                ...
                <section className="relative min-h-screen flex flex-col justify-end overflow-hidden border-b border-white/10">
                    <div
                        ...
                        style={{ backgroundImage: "url('/cases/onmacabim/hero.webp')" }}
                    />

                    <div
                        className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat opacity-35 block md:hidden"
                        style={{ backgroundImage: "url('/cases/onmacabim/hero_m.webp')" }}
                    />
